...
-- ============================================================================
-- Order-Revealing Encryption (ORE) operator classes for tde_ope_btree
-- ============================================================================
...
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (text,        text)        tde_ope_text_cmp(text, text);
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (int4,        int4)        tde_ope_int4_cmp(int4, int4);
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (int8,        int8)        tde_ope_int8_cmp(int8, int8);
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (uuid,        uuid)        tde_ope_uuid_cmp(uuid, uuid);
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (date,        date)        tde_ope_date_cmp(date, date);
ALTER OPERATOR FAMILY tde_ope_enc_ops_family USING tde_ope_btree
    ADD FUNCTION 1 (timestamptz, timestamptz) tde_ope_timestamptz_cmp(timestamptz, timestamptz);
