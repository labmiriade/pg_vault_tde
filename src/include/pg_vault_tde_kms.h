...
/*
 * Vault Transit API connector: fetches a new DEK from Vault.
 * Returns true on success (DEK stored in shmem), false on failure.
 * Non-fatal on failure — caller decides error policy.
 */
